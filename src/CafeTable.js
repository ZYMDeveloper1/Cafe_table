...
export default function CafeTable() {
  ...
  const columns = [
    ...
    { field: 'HouseholdNo', headerName: '# of groups', width: 98, type: 'number', editable: true },
    { field: 'BizTableNo', headerName: 'Table', width: 61, type: 'number', editable: true },
    {
      field: 'CheckInTime',
      headerName: 'Start Time',
      type: 'dateTime',
      valueFormatter: ({ value }) => moment(value).format('MM/DD, hh:mm'),
      width: 92,
      editable: true,
    },
    {
